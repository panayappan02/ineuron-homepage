    ...
    <div className="hero" id="hero">
      <div className="hero-content">
        <h1 className="hero-title">
          {/* OneNeuron the world's first
          <br /> OTT Platform for Education */}
          World's First OTT <br /> Platform for Education
        </h1>
        <p className="hero-description">
          Learn from the best of industry , Digital entrepreneurs, Youtubers and
          content creators provide affordable courses across technologies of
